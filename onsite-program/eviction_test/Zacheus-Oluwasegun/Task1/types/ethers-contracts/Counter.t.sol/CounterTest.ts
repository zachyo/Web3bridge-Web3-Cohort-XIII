...
export declare namespace StdInvariant {
  ...
  export interface CounterTestInterface extends Interface {
    getFunction(nameOrSignature: "IS_TEST" | "excludeArtifacts" | "excludeContracts" | "excludeSelectors" | "excludeSenders" | "failed" | "setUp" | "targetArtifactSelectors" | "targetArtifacts" | "targetContracts" | "targetInterfaces" | "targetSelectors" | "targetSenders" | "testFuzz_Inc" | "test_IncByZero" | "test_InitialValue"): FunctionFragment;
...
encodeFunctionData(functionFragment: 'testFuzz_Inc', values: [BigNumberish]): string;
encodeFunctionData(functionFragment: 'test_IncByZero', values?: undefined): string;
...
decodeFunctionResult(functionFragment: 'testFuzz_Inc', data: BytesLike): Result;
decodeFunctionResult(functionFragment: 'test_IncByZero', data: BytesLike): Result;
decodeFunctionResult(functionFragment: 'test_InitialValue', data: BytesLike): Result;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    testFuzz_Inc: TypedContractMethod<
      [x: BigNumberish, ],
      [void],
      'nonpayable'
    >
    ...
    test_IncByZero: TypedContractMethod<
      [],
      [void],
      'nonpayable'
    >
...
getFunction(nameOrSignature: 'targetSenders'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'testFuzz_Inc'): TypedContractMethod<
      [x: BigNumberish, ],
      [void],
      'nonpayable'
    >;
getFunction(nameOrSignature: 'test_IncByZero'): TypedContractMethod<
      [],
      [void],
      'nonpayable'
    >;
